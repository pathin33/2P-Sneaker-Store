    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="/" class="flex items-center">
                <img src="{{ asset('assets/icons/2PSS SNEAKERSS.png') }}" alt="2PSS SNEAKERS"
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-2 gap-4 p-4">
                            ...
                            <div>
                                ...
                                <a href="/new-arrivals"
                                    class="block px-3 py-2 text-gray-800 hover:bg-gray-50 hover:text-red-600 font-medium text-red-500">HÀNG
                                    MỚI VỀ</a>
                                <a href="/best-sellers"
            ...
            <div class="flex items-center space-x-5 md:space-x-6">
                ...
                <div class="relative group">
                    <button
                        ...
                        <img src="{{ asset('assets/icons/icon_search.png') }}" alt="Search"
                ...
                <a href="/wishlist"
                    ...
                    <img src="{{ asset('assets/icons/icon_favourite.png') }}" alt="Yêu thích"
                        class="h-5 w-5 md:h-6 md:w-6">
                    <span
                        class="wishlist-badge absolute -top-1.5 -right-1.5 bg-red-600 text-white rounded-full h-5 w-5 flex items-center justify-center text-xs font-bold">3</span>
                </a>
                ...
                <a href="/cart" class="p-1.5 rounded-full hover:bg-gray-100 transition-colors duration-200 relative">
                    ...
                    <span
                        class="cart-badge absolute -top-1.5 -right-1.5 bg-red-600 text-white rounded-full h-5 w-5 flex items-center justify-center text-xs font-bold">5</span>
                </a>
        ...
        <div class="container mx-auto px-4 space-y-3">
            ...
            <div class="relative">
                ...
                <div id="mobile-products-menu" class="hidden pl-4 mt-1 space-y-2">
                    ...
                    <a href="/new-arrivals" class="block py-1.5 text-gray-700 hover:text-red-600 text-red-500">Hàng
                        Mới Về</a>
