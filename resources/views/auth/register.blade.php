    ...
    <main class="flex items-center justify-center min-h-[calc(100vh-160px)]">
        <div class="w-full max-w-md px-6 py-8 bg-white rounded-xl shadow-lg">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Tạo tài khoản mới</h1>
                <p class="text-sm text-gray-500">Điền thông tin để đăng ký tài khoản</p>
            </div>
            ...
            <form class="space-y-5">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="first-name" class="block text-sm font-medium text-gray-700 mb-1">Họ</label>
                    ...
                    <div>
                        <label for="last-name" class="block text-sm font-medium text-gray-700 mb-1">Tên</label>
                        <input type="text" id="last-name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Nhập tên của bạn">
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        Tôi đồng ý với <a href="#" class="text-blue-600 hover:underline">Điều khoản dịch vụ</a> và <a href="#" class="text-blue-600 hover:underline">Chính sách bảo mật</a>
                    </label>
                </div>
