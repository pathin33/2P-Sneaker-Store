        ...
        <div class="w-full max-w-md px-6 py-8 bg-white rounded-xl shadow-lg">
            ...
            <form class="space-y-5">
                <div>
                    ...
                    <div class="relative">
                        <input type="email" id="email" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Nhập email của bạn" required>
